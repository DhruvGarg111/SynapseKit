...
_LAZY_IMPORTS = {
    ...
    "ClarifaiLLM": "llm.clarifai",
    "BasetenLLM": "llm.baseten",
    "DeepInfraLLM": "llm.deepinfra",
    "FriendliLLM": "llm.friendli",
    "HyperbolicLLM": "llm.hyperbolic",
    "NvidiaNIMLLM": "llm.nvidia_nim",
    "NebiusLLM": "llm.nebius",
    "RekaLLM": "llm.reka",
    "SnowflakeCortexLLM": "llm.snowflake_cortex",
    "UpstageLLM": "llm.upstage",
    "WatsonxLLM": "llm.watsonx",
    ...
    "MongoDBCheckpointer": "graph.checkpointers.mongodb",
    "CassandraCheckpointer": "graph.checkpointers.cassandra",
    "ScyllaCheckpointer": "graph.checkpointers.cassandra",
    "ScyllaDBCheckpointer": "graph.checkpointers.scylla",
    "DynamoDBCheckpointer": "graph.checkpointers.dynamodb",
    "FirestoreCheckpointer": "graph.checkpointers.firestore",
    "CosmosDBCheckpointer": "graph.checkpointers.cosmos",
    "MongoDBMemoryBackend": "memory.backends.mongodb",
    "CassandraMemoryBackend": "memory.backends.cassandra",
    "ScyllaMemoryBackend": "memory.backends.cassandra",
    "ScyllaDBMemoryBackend": "memory.backends.scylla",
    "DynamoDBMemoryBackend": "memory.backends.dynamodb",
    "FirestoreMemoryBackend": "memory.backends.firestore",
    "CosmosDBMemoryBackend": "memory.backends.cosmos",
    # Loaders
